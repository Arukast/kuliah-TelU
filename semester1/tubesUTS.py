...
def pembayaran_0301(tota_0301):
    ...
    nominal_pembayaran_0301 = float(input("Masukan nominal pembayaran Anda: Rp. "))
...
def menu_minuman_0301():
    ...
    if berapa_0301 < 6:
        while berapa_0301 > 0:
            ...
            if (
                terpilih_0301.title() in list_0301
                and terpilih_0301.title() not in pesanan_minuman_0301
            ):
                ...
                terpilih_0301.title() in list_0301
                and terpilih_0301.title() in pesanan_minuman_0301
            ):
    ...
    # Menampilkan Pesanan
    print("--- Pesanan Anda ---")
    for x_0301, y_0301, z_0301 in zip(
        pesanan_minuman_0301, jumlah_minuman_0301, total_perminuman_0301
    ):
        print(
...
def menu_makanan_0301():
    ...
    if berapa_0301 < 6:
        while berapa_0301 > 0:
            ...
            if (
                terpilih_0301.title() in list_0301
                and terpilih_0301.title() not in pesanan_makanan_0301
            ):
                jumlah_terpilih_0301 = int(
                    input(f"Berapa jumlah {terpilih_0301.title()} yang Anda mau: ")
                )
                ...
                terpilih_0301.title() in list_0301
                and terpilih_0301.title() in pesanan_makanan_0301
            ):
                print(f"{terpilih_0301.title()} sudah tercatat di pesanan Anda")
            else:
    ...
    print("--- Pesanan Anda ---")
    for x_0301, y_0301, z_0301 in zip(
        pesanan_makanan_0301, jumlah_makanan_0301, total_permakanan_0301
    ):
        print(
            f"{y_0301} {x_0301} dengan harga satuan Rp. {list_0301.get(x_0301)} , jadi total harga {y_0301} {x_0301} adalah Rp. {z_0301}"
        )
...
print(
    "Disini terdapat dua menu, yaitu makanan dan minuman. Anda hanya bisa memilih salah satu menu saja"
)
...
nim_0301 = [
    database_Test_0301.get("NIM"),
    database_admin_0301.get("NIM"),
]
nama_0301 = [
    database_Test_0301.get("Nama"),
    database_admin_0301.get("Nama"),
]
norek_0301 = [
    database_Test_0301.get("No. Rekening"),
    database_admin_0301.get("No. Rekening"),
]
pin_0301 = [database_Test_0301.get("PIN"), database_admin_0301.get("PIN")]
saldo_0301 = [database_Test_0301.get("Saldo"), database_admin_0301.get("Saldo")]
...
def menu_tarik_uang_0301(user_0301):
    ...
    database_Test_0301.update({"Saldo": sakhir_menu_0301})
...
def login_0301():
    ...
    if (
        login_nim_0301 in nim_0301
        and login_nama_0301 == nama_0301[nim_0301.index(login_nim_0301)]
        and login_norek_0301 == norek_0301[nim_0301.index(login_nim_0301)]
        and norek_pin_0301 == pin_0301[nim_0301.index(login_nim_0301)]
    ):
