...
print(
    "Function adalah sebuah blok kode yang dirancang untuk melakukan tugas tertentu, dan dapat dipanggil kembali di bagian lain dari program"
)
...
def main():
    ...
    print(f"Rata-rata dari sejumlah angka yang Anda masukan adalah: {rata_rata_akhir}")
